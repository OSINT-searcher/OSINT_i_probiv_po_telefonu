...
|----------|------------------------------------------------------------------|----------------------------------------|
|📲♻️🆓| [Vektor](https://t.me/osinttejsjsisisoslslkleik_bot?start=r_eFGr1BT2b5)| Бот для поиска по телефону и множеству других данных, с неплохими базами и выдачей информации.|
|📲🪙| [Sherlock](https://t.me/SHERLOCJSISIXJDJEIDIDOFII_bot?start=_ref_9pyalm_JJwlz5)| Неплохой бот с разными базами и функциями поиска, срежи которых и поиск/пробив по номеру телефона.|
|📲🪙| [Enigma](https://t.me/stariesxbot?start=C96FP5YS)| Универсальный поисковой бот. Ищет по разным данным, в том числе и по телефонам нескольких СНГ стран.|
|📲🪙| [Himera](https://t.me/HimeraBl8gVsv5uhYG_Search_bot?start=406840159)| Бот соблюдающий законы, обладающий функцией поиска по номеру телефона. Т.к. работает законно - лучший вариант для честного поиска, но из-за этого и подороже.|
|📲🪙🆓| [Funstat](https://t.me/funstattelelogmirrorbot?start=01015FE33F1800000000)| Бот поиска по Телеграм. Имеет функцию **/text**, которая позволяет искать сообщения в чатах, что позволяет искать номера телефонов по открытым сообщениям в ТГ.|
