...
* Криптовалюта. Создайте кошелек.

Эти варианты упрощают работу.
...
* [📲 Sherlock](https://t.me/pojssk666bot_bot?start=_ref_9pyalm_JJwlz5) - неплохой бот с разными базами и функциями поиска, срежи которых и поиск/пробив по номеру телефона.
