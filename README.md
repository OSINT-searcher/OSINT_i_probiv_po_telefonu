...
|----------|------------------------------------------------------------------|----------------------------------------|
|📲🪙🆓| [Sherlock](https://t.me/Sreshulya_bot?start=_ref_9pyalm_JJwlz5)| Неплохой бот с разными базами и функциями поиска, среди которых и поиск/пробив по номеру телефона.|
...
|📲🪙🆓| [Funstat](https://t.me/anitafsanstat_bot?start=01083996516B74617466)| Бот поиска по Телеграм. Имеет функцию **/text**, которая позволяет искать сообщения в чатах, что позволяет искать номера телефонов по открытым сообщениям в ТГ.|
