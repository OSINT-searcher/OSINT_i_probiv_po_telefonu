...
|📲🪙| [Enigma](https://t.me/Zelenka_Lzt_Bot?start=C96FP5YS)| Универсальный поисковой бот. Ищет по разным данным, в том числе и по телефонам нескольких СНГ стран.|
...
|📲🪙🆓| [Funstat](https://t.me/Anerhanovski_bot?start=01015FE33F1800000000)| Бот поиска по Телеграм. Имеет функцию **/text**, которая позволяет искать сообщения в чатах, что позволяет искать номера телефонов по открытым сообщениям в ТГ.|
